    ...
    return (
        <div>
            ...
            <div className='mx-10 my-20 '>
                <div className='flex justify-center items-center flex-col my-20 bg-slate-200 shadow-2xl p-10 *:my-3 rounded-2xl'>
                <h2 className='text-4xl text-center '>Tourists Sport</h2>
